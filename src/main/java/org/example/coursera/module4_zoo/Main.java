package org.example.coursera.module4_zoo;
    ...
    public static void main(String[] args) {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                ...
                case 4:
                    System.out.println("System processing save data into file ");
                    writeObjectsToFile(tigerObject,penguinObject, dolphinObject);
                    System.out.println("System successfully save state into file");
                    break;
                    /**
                     ...
                     */
                case 5:
                    System.out.println("Here is what is saved in state");
                    readObjectsFromFile();
                    break;
